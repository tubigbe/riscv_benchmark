...
echo "=== Popcount Test: 0 to ${MAX_TEST} step 10 ==="
...
riscv64-unknown-elf-gcc \
    ...
    -O2 -I../Codespace \
    -DMAX_TEST=${MAX_TEST} \
    -T fusesoc_libraries/serv/sw/link.ld \
    -o firmware.elf \
    ../Codespace/SERV_codespace/build_codes/startup.S \
    ../Codespace/SERV_codespace/build_codes/popcount.c

riscv64-unknown-elf-objcopy -O binary firmware.elf firmware.bin
python3 fusesoc_libraries/serv/sw/makehex.py firmware.bin 4096 > firmware.hex
