...
void Vservant_sim___024root__trace_chg_0_sub_0(Vservant_sim___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgBit(oldp+66,((1U & ((~ (IData)(vlSymsp->TOP__servant_sim__dut.__PVT__cpu__DOT__wb_ibus_stb)) 
        ...
        bufp->chgBit(oldp+68,(vlSymsp->TOP__servant_sim__dut.__PVT__cpu__DOT__wb_ibus_stb));
        bufp->chgBit(oldp+69,(vlSymsp->TOP__servant_sim__dut.__PVT__cpu__DOT__wb_ibus_ack));
        bufp->chgBit(oldp+70,(vlSymsp->TOP__servant_sim__dut.__PVT__cpu__DOT__wb_dbus_ack));
        bufp->chgBit(oldp+71,(((~ (IData)(vlSymsp->TOP__servant_sim__dut.__PVT__cpu__DOT__wb_ibus_stb)) 
    ...
    if (VL_UNLIKELY(vlSelfRef.__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+80,(vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_dat),32);
        ...
        bufp->chgIData(oldp+101,(vlSymsp->TOP__servant_sim__dut.__PVT__cpu__DOT__wb_dbus_rdt),32);
        ...
        bufp->chgBit(oldp+112,(vlSymsp->TOP__servant_sim__dut.__PVT__cpu__DOT__rdata1));
        ...
        bufp->chgBit(oldp+184,(vlSymsp->TOP__servant_sim__dut.__PVT__cpu__DOT__cpu__DOT__csr_in));
