...
VL_INLINE_OPT void Vservant_sim_servant_ram__D2000_R4d494e49___ico_sequent__TOP__servant_sim__dut__ram__0(Vservant_sim_servant_ram__D2000_R4d494e49* vlSelf) {
    ...
    vlSelfRef.__PVT__we = ((- (IData)(((IData)(vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_stb) 
                                       & ((~ (IData)(vlSymsp->TOP__servant_sim__dut.__PVT__cpu__DOT__wb_ibus_stb)) 
...
VL_INLINE_OPT void Vservant_sim_servant_ram__D2000_R4d494e49___nba_sequent__TOP__servant_sim__dut__ram__0(Vservant_sim_servant_ram__D2000_R4d494e49* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vservant_sim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    ...
    if ((1U & (IData)(vlSelfRef.__PVT__we))) {
        __VdlyVal__mem__v0 = (0xffU & vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_dat);
        __VdlyDim0__mem__v0 = (0x7ffU & (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_adr 
                                         >> 2U));
        __VdlySet__mem__v0 = 1U;
    }
    if ((2U & (IData)(vlSelfRef.__PVT__we))) {
        __VdlyVal__mem__v1 = (0xffU & (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_dat 
                                       >> 8U));
        __VdlyDim0__mem__v1 = (0x7ffU & (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_adr 
                                         >> 2U));
        __VdlySet__mem__v1 = 1U;
    }
    if ((4U & (IData)(vlSelfRef.__PVT__we))) {
        __VdlyVal__mem__v2 = (0xffU & (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_dat 
                                       >> 0x10U));
        __VdlyDim0__mem__v2 = (0x7ffU & (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_adr 
                                         >> 2U));
        __VdlySet__mem__v2 = 1U;
    }
    if ((8U & (IData)(vlSelfRef.__PVT__we))) {
        __VdlyVal__mem__v3 = (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_dat 
                              >> 0x18U);
        __VdlyDim0__mem__v3 = (0x7ffU & (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_adr 
                                         >> 2U));
        __VdlySet__mem__v3 = 1U;
    }
    vlSelfRef.__PVT__o_wb_rdt = vlSelfRef.mem[(0x7ffU 
