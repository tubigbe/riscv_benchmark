    ...
    , TOP__servant_sim__dut__ram{this, Verilated::catName(namep, "servant_sim.dut.ram")}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        __Vscope_servant_sim__dut__ram.varInsert(__Vfinal,"mem", &(TOP__servant_sim__dut__ram.mem), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,2 ,31,0 ,0,2047);
    }
}
