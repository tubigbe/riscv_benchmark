...
#ifndef VERILATED_VSERVANT_SIM_SERVANT__PI1_H_
#define VERILATED_VSERVANT_SIM_SERVANT__PI1_H_  // guard

#include "verilated.h"
class Vservant_sim_servant_ram__D8000_R4d494e49;


class Vservant_sim__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vservant_sim_servant__pi1 final : public VerilatedModule {
  public:
    // CELLS
    Vservant_sim_servant_ram__D8000_R4d494e49* ram;
    ...
    // CONSTRUCTORS
    Vservant_sim_servant__pi1(Vservant_sim__Syms* symsp, const char* v__name);
    ~Vservant_sim_servant__pi1();
    VL_UNCOPYABLE(Vservant_sim_servant__pi1);
