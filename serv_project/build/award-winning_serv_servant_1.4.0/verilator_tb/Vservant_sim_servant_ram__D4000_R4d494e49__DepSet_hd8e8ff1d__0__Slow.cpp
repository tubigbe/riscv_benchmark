...
VL_ATTR_COLD void Vservant_sim_servant_ram__D4000_R4d494e49___ctor_var_reset(Vservant_sim_servant_ram__D4000_R4d494e49* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vservant_sim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vservant_sim_servant_ram__D4000_R4d494e49___ctor_var_reset\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->__PVT__i_wb_clk = VL_RAND_RESET_I(1);
    vlSelf->__PVT__i_wb_rst = VL_RAND_RESET_I(1);
    vlSelf->__PVT__i_wb_adr = VL_RAND_RESET_I(12);
