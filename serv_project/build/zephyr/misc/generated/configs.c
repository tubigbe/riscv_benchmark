...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SERV_TIMER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RISCV_SOC_EXCEPTION_FROM_IRQ, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MMIO_SRAM_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_BITBANG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_SERV_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_SERVICE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_RISCV32_SERVANT, 1);
